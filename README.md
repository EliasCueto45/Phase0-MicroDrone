# Phase 0 MicroDrone — RCOS Fall 2026
...
This README is the central working outline for the RCOS team. It describes proposed work, not completed functionality. The repository currently contains documentation and placeholder files; a reproducible runtime and dependency setup still need to be established.
...
The [Student Engineering Packet V3](docs/STUDENT%20ENGINEERING%20PACKET%20V3.pdf) describes a broader system and contains conflicting publication, ownership, hardware, and student-deliverable requirements. Use this working proposal for semester planning; the project stakeholders still need to reconcile those requirements. This README does not resolve ownership or licensing agreements. The repository includes an [MIT license](LICENSE.md); third-party dependencies and assets retain their own licenses.
